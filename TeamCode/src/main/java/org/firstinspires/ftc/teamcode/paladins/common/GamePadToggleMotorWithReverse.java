 ...
 */
public class GamePadToggleMotorWithReverse extends PaladinsComponent {
     ...
     */
    public GamePadToggleMotorWithReverse(PaladinsOpMode opMode, Gamepad gamepad, DcMotor motor, ButtonControl buttonControl, ButtonControl buttonControl2, float power, boolean showTelemetry) {
        super(opMode);
    ...
    public GamePadToggleMotorWithReverse(PaladinsOpMode opMode, Gamepad gamepad, DcMotor motor, ButtonControl buttonControl, ButtonControl buttonControl2, float power) {
